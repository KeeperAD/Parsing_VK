...
#
#
# Само скачивание взято у https://proglib.io/p/python-vk-api-1/ , но переделано под другую библиотеку и добавлены другие
# опции по VK API и просто удобные для работы
